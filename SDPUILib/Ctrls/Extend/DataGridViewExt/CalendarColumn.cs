...
namespace SDPUILib.Ctrls.DataGridViewExt
{
    public class CalendarColumn : DataGridViewColumn
    {
        ...
        public override DataGridViewCell CellTemplate
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidCastException("必须是CalendarCell类型！");
                }
    ...
    public class CalendarCell : DataGridViewTextBoxCell
    {
        ...
        public override void InitializeEditingControl(int rowIndex, object initialFormattedValue, DataGridViewCellStyle dataGridViewCellStyle)
        {
            ...
            {
                ctl.Value = DateTime.Parse(value);
            }            
        }
    ...
    class CalendarEditingControl : DateTimePicker, IDataGridViewEditingControl
    {
        ...
        public void ApplyCellStyleToEditingControl(DataGridViewCellStyle dataGridViewCellStyle)
        {
            ...
            if (!dataGridViewCellStyle.Format.Equals(""))
            {
                this.Format = DateTimePickerFormat.Custom;

                this.CustomFormat = dataGridViewCellStyle.Format;

                //System.Console.Out.WriteLine("Format=" + this.Format + ", CustomFormat=" + this.CustomFormat);
            }
            else
            {
                this.Format = DateTimePickerFormat.Short;
